...
*/
	...
	class Candidate {
		...
		function setCandLastName($cln){ 			//Candidate last name setter funtion
			$this->candidateLastName = $cln; 
		}         
		function getCandLastName(){ 				//Candidate last name getter funtion
			return $this->candidateLastName;
		}      
		function setCandidateFirstName($cfn){ 		//Candidate first name setter funtion
			$this->candidateFirstName = $cfn; 
		}         
		function getCandidateFirstName(){ 			//Candidate first name getter funtion
			return $this->candidateFirstName; 
		}      
		function setCandidateRank($cr){ 			//Candidate rank setter funtion
			$this->candidateRank = $cr; 
		}         
		function getCandidateRank(){ 				//Candidate rank getter funtion
			return $this->candidateRank; 
		}      
		function setCandidateSex($cs){ 				//Candidate sex setter funtion
			$this->candidateSex = $cs; 
		}         
		function getCandidateSex(){ 				//Candidate sex getter funtion
			return $this->candidateSex; 
		}      
		function setMentorLastName($mln){ 			//Mentor's last name setter funtion
			$this->mentorLastName = $mln; 
		}         
		function getMentorLastName(){ 				//Mentor's last name getter funtion
			return $this->mentorLastName; 
		}   
		function setMentorRank($mr){ 				//Mentor's rank setter funtion
			$this->mentorRank = $mr; 
		} 	
		function getMentorRank(){ 					//Mentor's rank getter funtion
			return $this->mentorRank; 
		}         
		function setSeniorLastName($sln){ 			//Senior Drill Sergeant's last name setter funtion
			$this->seniorLastName = $sln; 
		}         
		function getSeniorLastName(){ 				//Senior Drill Sergeant's last name getter funtion
			return $this->seniorLastName; 
		}      	
		function setSeniorRank($sr){ 				//Senior Drill Sergeant's rank setter funtion
			$this->seniorRank = $sr; 
		}         
		function getSeniorRank(){ 					//Senior Drill Sergeant's rank getter funtion
			return $this->seniorRank; 
		} 
		function setDateAssigned($da){ 				//Date candidate was assigned to the untit setter funtion
			$this->dateAssigned = $da; 
		}         
		function getDateAssigned(){ 				//Date candidate was assigned to the untit getter funtion
			return $this->dateAssigned; 
		} 
		function setDSADate($dsad){ 				//Projected or Actual DSA date setter funtion
			$this->dsaDate = $dsad; 
		}         
		function getDSADate(){ 						//Projected or Actual DSA date getter funtion
			return $this->dsaDate; 
		}    
		function setLastAPFT($apftd){ 				//Candidates last Record APFT date setter funtion
			$this->lastAPFT = $apftd; 
		}         
		function getLastAPFT(){ 					//Candidates last Record APFT date getter funtion
			return $this->lastAPFT; 
		}          
		function setBHAppt($bha){ 					//Behavioral Health Date setter funtion
			$this->bhAppt = $bha; 
		}         
		function getBHAppt(){ 						//Behavioral Health Date getter funtion
			return $this->bhAppt; 
		}  
		function setQualDate($qd){ 					//Last weapons qualification date setter funtion
			$this->qualDate = $qd; 
		}         
		function getQualDate(){ 					//Last weapons qualification date getter funtion
			return $this->qualDate; 
		}    
		function setRFODate($rfo){ 					//RFO submission date setter funtion
			$this->rfoDate = $rfo; 
		}         
		function getRFODate(){ 						//RFO submission date getter funtion
			return $this->rfoDate; 
		}           
		function setOrdersReceived($or){ 			//Orders Received setter funtion
			$this->ordersReceived = $or; 
		}         
		function getOrdersReceived(){ 				//Orders Received getter funtion
			return $this->ordersReceived; 
		}         
		function setDTSCreated($dtsc){ 				//DTS Authorization Created setter funtion
			$this->dtsCreated = $dtsc; 
		}         
		function getDTSCreated(){ 					//DTS Authorization Created getter funtion
			return $this->dtsCreated; 
		}         
		function setDTSApproved($dtsa){ 			//DTS Authorization Approved setter funtion
			$this->dtsApproved = $dtsa; 
		}         
		function getDTSApproved(){ 					//DTS Authorization Approved getter funtion
			return $this->dtsApproved; 
		}         
		function setFirstThree($ft){ 				//Can pitch First Three Moduals setter funtion
			$this->firstThree = $ft; 
		}         
		function getFirstThree(){ 					//Can pitch First Three Moduals getter funtion
			return $this->firstThree; 
		}         
		function setTwoClasses($tc){ 				//Taught Two Classes setter funtion
			$this->twoClasses = $tc; 
		}         
		function getTwoClasses(){ 					//Taught Two Classes getter funtion
			return $this->twoClasses; 
		}     
		function setPRT($prt){ 						//PRT Proficiency setter funtion
			$this->prt = $prt; 
		}         
		function getPRT(){ 							//PRT Proficiency getter funtion
			return $this->prt; 
		}             
		function setVoiceCommands($vc){ 			//Voice Commands Exercises setter funtion
			$this->voiceCommands = $vc; 
		}         
		function getVoiceCommands(){ 				//Voice Commands Exercises getter funtion
			return $this->voiceCommands; 
		}         
		function setDAndC($dc){ 					//Drill & Ceremony setter funtion
			$this->dAndC = $dc; 
		}         
		function getDAndC(){ 						//Drill & Ceremony getter funtion
			return $this->dAndC; 
		}         
		function setCreeds($c){				 		//Learned DS and Soldier Creeds setter funtion
			$this->creeds = $c; 
		}         
		function getCreeds(){ 						//Learned DS and Soldier Creeds getter funtion
			return $this->creeds; 
		}   
		function setPassedAPFTHW($passed){ 			//Passed APFT and HW setter funtion
			$this->passedAPFTHW = $passed; 
		}         
		function getPassedAPFTHW(){ 				//Passed APFT and HW getter funtion
			return $this->passedAPFTHW; 
		}
		function setDSHistBadgeHat($hist){ 			//DS History, Badge, Campaign/Bush Hat setter funtion
			$this->dsHistBadgeHat = $hist; 
		}         
		function getDSHistBadgeHat(){ 				//DS History, Badge, Campaign/Bush Hat getter funtion
			return $this->dsHistBadgeHat; 
		}
		function setRiskManagement($risk){ 			//Composit Risk Management setter funtion
			$this->riskManagement = $risk; 
		}         
		function getRiskManagement(){ 				//Composit Risk Management getter funtion
			return $this->riskManagement; 
		}
		function setSensitiveDuty($sd){ 			//Aquired Sensitive Duty (DA7424) setter funtion
			$this->sensitiveDuty = $sd; 
		}         
		function getSensitiveDuty(){ 				//Aquired Sensitive Duty (DA7424) getter funtion
			return $this->sensitiveDuty; 
		}
		function setMedRelease($mr){ 				//Aquired Medical Release (DA2870) setter funtion
			$this->medRelease = $mr; 
		}         
		function getMedRelease(){ 					//Aquired Medical Release (DA2870) getter funtion
			return $this->medRelease; 
		}
		function setASU($asu){	 					//Possess updated ASU's setter funtion
			$this->asu = $asu; 
		}         
		function getASU(){ 							//Possess updated ASU's getter funtion
			return $this->asu; 
		}
		function setEquipment($e){ 					//Posses all equipment on school checklist setter funtion
			$this->equipment = $e; 
		}         
		function getEquipment(){ 					//Posses all equipment on school checklist getter funtion
			return $this->equipment; 
		}	
		function setGovtc($govtc){ 					//Government Travel Card setter funtion
			$this->govtc = $govtc; 
		}         
		function getGovtc(){ 						//Government Travel Cardgetter funtion
			return $this->govtc; 
		}	
		function setMentalEval($me){ 				//Mental Evaluation setter funtion
			$this->mentalEval = $me; 
		}         
		function getMentalEval(){ 					//Mental Evaluation getter funtion
			return $this->mentalEval; 
		}	
		function setComments($c){ 					//Comments setter funtion
			$this->comments = $c; 
		}         
		function getComments(){ 					//Comments getter funtion
			return $this->comments; 
		}
		function setViable($v){ 					//Are they a viable candidate setter funtion
			$this->viable = $v; 
		}         
		function getViable(){ 						//Are they a viable candidate getter funtion
			return $this->viable; 
		}
		function setReady($r){ 						//Aquired Medical Release (DA2870) setter funtion
			$this->ready = $r; 
		}         
		function getReady(){ 						//Are they ready to attend DSA getter funtion
			return $this->ready; 
		}	
		function setCommitted($c){	 				//Have they picked a school date to attend DSA? setter funtion
			$this->committed = $c; 
		}         
		function getCommitted(){ 					//Have they picked a school date to attend DSA? getter funtion
			return $this->committed; 
		}	
		function setEnrolled($e){ 					//Have they been given a slot in a DSA class? setter funtion
			$this->enrolled = $e; 
		}         
		function getEnrolled(){ 					//Have they been given a slot in a DSA class? getter funtion
			return $this->enrolled; 
		}			
		function setInSchool($s){ 					//Are they currently attending DSA? setter funtion
			$this->inSchool = $s; 
		}         
		function getInSchool(){ 					//Are they currently attending DSA? getter funtion
			return $this->inSchool; 
		}		
		function setGraduated($g){ 					//Have they graduated DSA? (Yes/No)
			$this->graduated = $g; 
		}         
		function getGraduated(){ 					//Have they graduated DSA? (Yes/No)
			return $this->graduated; 
		}	
		
		
		function setStillInProgram($sip){ 			//Are they still in the unit as a DSC on the UMR? setter funtion
			$this->stillInProgram = $sip; 
		}         
		function getStillInProgram(){ 				//CAre they still in the unit as a DSC on the UMR? getter funtion
	...
	echo '
	<div class = "innter-container" id = "inner-container' . $i . '" style = "visibility: hidden; height: 0px;">
		<div class = "split left left-side" id ="top-left-section">
...
echo '		
		...
		<div class = "split right right-side" id = "top-right-secton">
...
echo'<!--The "HOME" screen for Company Drill Sergeant Candidate Statistics-->
	<div class = "inner-container" id = "inner-container99" style = "visibility: visible;">
		...
		<div class = "picture-container-head">
			<img id = "badge" src = "dsc_files\photos\badge.jpeg" alt = "ds badge"> 
			<p class = "home-title">A Company 3rd BN 518 RGT</p>
			<p class = "home-title">DS Candidate Statistics</p>
			<img id = "div" src = "dsc_files\photos\98th.png" alt = "98th Division"> 
			<hr>
			<div id = "viable-sex">
				<table id="top-table">
					<tr>
...
<div id = "choose">
	<div class = "selection" id = "home-screen" onclick = "selectCandidate(99, ' . $numberOfCandidates .')">
